...
url = 'https://www.dm5.com/manhua-qiangweishaonv/'
driver = webdriver.Chrome()
driver.get(url)
html = etree.HTML(driver.page_source)
chapter_title = html.xpath('/html/body/div[4]/div/div[2]/div[1]/div[2]/ul/li/a/text()')
chapter_links=html.xpath('/html/body/div[4]/div/div[2]/div[1]/div[2]/ul/li/a/@href') # Get the href attribute instead of the text

chapter_links = ['https://www.dm5.com' + link for link in chapter_links] # Add the prefix to each link
